...
let fragmentShader = `
    ...
    void main() {                      
        ...
        outColor = calculateLights(normalize(vNormal), vPosition) * (texture(tex, (v_uv) * 1.5 * floor(tan(time * 2.9)))
...
loadImages(["images/tigertex.jpg", "images/cubemap.jpg", "images/tigersquare.jpg"], function (images) {
let drawCall = app.createDrawCall(program, vertexArray)
    .texture("tex", app.createTexture2D(images[0], images[0].width, images[0].height, {flipY: true, magFilter: PicoGL.ANISOTROPIC, wrapT: PicoGL.REPEAT, wrapS: PicoGL.MIRRORED_REPEAT}))
